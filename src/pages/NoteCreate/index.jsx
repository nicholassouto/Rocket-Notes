...
export function NoteCreate() {
  ...
  async function handleNewNote() {
    ...
    if (newLink) {
      return alert("você deixou um link no campo sem adcionar, adcione ele ou deixe o campo vazio");
    }

    if (newTag) {
      return alert("você deixou uma tag no campo sem adcionar, adcione ela ou deixe o campo vazio");
    }
